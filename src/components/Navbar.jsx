...
const NavButton = ({title, customFac, icon, color, dotColor }) => (
  <TooltipComponent content={title} position='BottomCenter'>
    <button type='button' onClick={customFac}
...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <NavButton 
        title='Menu' 
        customFac={()=> setActiveMenu((preActiveMenu)=> !preActiveMenu)} 
        color='blue' 
        icon={<AiOutlineMenu/>} 
      />
...
<       NavButton 
          title='Notification'
          dotColor='#03C9D7'
          customFac={()=> handleClick('notification')} 
          color='blue' 
          ...
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg'
            onClick={()=> handleClick('userProfile')}>
              ...
              <p>
                ...
                <span className='text-gray-400 font-bold ml-3 text-14'>Michale</span>
              </p>
